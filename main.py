...
if __name__ == '__main__':
    ...
    parser.add_argument('--lambda_fm', type=float, default=1, help='weight for reconstruction loss')
    ...
    parser.add_argument('--mode', type=str, default='train', choices=['train', 'test', 'test2'])
